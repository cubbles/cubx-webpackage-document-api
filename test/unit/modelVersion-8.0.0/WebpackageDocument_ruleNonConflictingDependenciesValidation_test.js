...
describe('WebpackageDocument Artifact.endpoint.dependencies -Rule Validation (modelVersion 8.0.0)', function () {
  ...
  describe('validate', function () {
    ...
    var webpackageDocument;
    describe('\'manifest.webpackage_invalidArtifactsEndpointsDueToDuplicateDependencies\'', function () {
      var manifestWebpackageString;
      beforeEach(function () {
        var pathName = path.resolve(__dirname, '../../resource/modelVersion-8.0.0/manifest.webpackage_invalidArtifactsEndpointsDueToDuplicateDependencies');
