...
describe('WebpackageDocument Schema Validation 4 Property Values (modelVersion 8.0.0)', function () {
  ...
  describe('validate', function () {
    ...
    describe('valid \'manifest.webpackage\'', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname + '/../../resource/modelVersion-8.0.0/manifest.webpackage', 'utf8')
      })
    ...
    describe('valid \'manifest.webpackage_requiredAttributesOnly\'', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname + '/../../resource/modelVersion-8.0.0/manifest.webpackage_requiredAttributesOnly', 'utf8')
      })
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname +
            '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidModelVersion', 'utf8')
      })
    ...
    describe('valid \'manifest.webpackage_invalidValues\'', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname + '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidValues',
            'utf8')
      })
