...
describe('WebpackageDocument Elementary.slots.slotId -Rule Validation (modelVersion 8.0.0)', function () {
  ...
  describe('validate', function () {
    ...
    var webpackageDocument;
    describe('\'manifest.webpackage_invalidElementaryDueToDuplicateSlotId\'', function () {
      var manifestWebpackageString;
      beforeEach(function () {
        var pathName = path.resolve(__dirname, '../../resource/modelVersion-8.0.0/manifest.webpackage_invalidElementaryDueToDuplicateSlotId');
