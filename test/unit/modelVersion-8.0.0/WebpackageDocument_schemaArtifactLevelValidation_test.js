...
describe('WebpackageDocument Schema Validation (modelVersion 8.0.0)', function () {
  ...
  describe('validate', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname +
            '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidArtifactDeclaration1', 'utf8')
      })
    ...
    describe('\'manifest.webpackage_invalidDueToDuplicateArtifactId\'', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname + '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidArtifactDeclaration0', 'utf8')
      })
    ...
    describe('invalidArtifactDeclaration by artifact-name', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname +
            '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidArtifactDeclaration2', 'utf8')
      })
    ...
    describe('invalidCompoundDeclaration', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname +
            '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidArtifactDeclaration3', 'utf8')
      })
    ...
    describe('invalidUtilDeclaration due to missing any endpoint declaration', function () {
      ...
      beforeEach(function () {
        manifestWebpackageString =
          fs.readFileSync(__dirname +
            '/../../resource/modelVersion-8.0.0/manifest.webpackage_invalidUtilityDueToMissingAnyEndpoint', 'utf8')
      })
