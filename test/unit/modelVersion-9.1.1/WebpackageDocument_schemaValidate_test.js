...
describe('WebpackageDocument Schema Validation (modelVersion 9.1.1)', function () {
  ...
  describe('validate', function () {
    ...
    describe('validation for resource and deendencies as direct properties', function () {
      ...
      beforeEach(function () {
        var pathName = path.resolve(__dirname, '../../resource/modelVersion-9.1.1/manifest.webpackage');
