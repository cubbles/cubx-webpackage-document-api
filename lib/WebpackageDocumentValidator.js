...
(function () {
  ...
  WebpackageDocumentValidator.schema[ '8.0.0' ] = {}
  WebpackageDocumentValidator.schema[ '8.1.0' ] = {}
  WebpackageDocumentValidator.schema[ '8.2.0' ] = {}
  WebpackageDocumentValidator.schema[ '8.3.0' ] = {}

  WebpackageDocumentValidator.schema[ '8.0.0' ].manifestWebpackageSchema =
    require('./jsonSchema/manifestWebpackageSchema-8.0.0.js')
  WebpackageDocumentValidator.schema[ '8.1.0' ].manifestWebpackageSchema =
    require('./jsonSchema/manifestWebpackageSchema-8.1.0.js')
  WebpackageDocumentValidator.schema[ '8.2.0' ].manifestWebpackageSchema =
    require('./jsonSchema/manifestWebpackageSchema-8.2.0.js')
  WebpackageDocumentValidator.schema[ '8.3.0' ].manifestWebpackageSchema =
    require('./jsonSchema/manifestWebpackageSchema-8.3.0.js')
